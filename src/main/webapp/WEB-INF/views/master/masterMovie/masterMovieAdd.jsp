	 ...
	 <div class="main">
        ...
        <div class="tableMovie">
            ...
            <div class="movieInfo">
                ...
                영화 등급 :   <input type="text" name= "ageLimit" id="ageLimit" readonly>
                영화 상영 시간 : <input type="text" name= "runningTime" id="runningTime" readonly>
                                <input type="hidden" name="movieCode" id="movieSeq" readonly>
            </div>
        </div>
        <div>
