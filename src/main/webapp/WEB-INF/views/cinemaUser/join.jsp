...
<div class="mainBody">
	...
	<form id="mainForm" method="POST">
		<div class="Form">
			...
			<input type="text" class="joinIdInput" name="userId" id="userIdValue">
		</div>
		...
		<div class="Form">
			...
			<div>
				<input type="text" class="joinBirth" name="userSn1">
			</div>
			-
			<div>
				<input type="text" class="joinGender" name="userSn2">
			</div>
		...
		<div class="phoneForm">
			...
			<input type="hidden" name="userPh" id="userPhHidden"> <select
				class="joinPhoneOne" name="userPh1">
				<option selected>010</option>
				<option>011</option>
				<option>012</option>
				<option>017</option>
				<option>070</option>
			</select> - <input type="text" class="joinPhone" name="userPh2"> - <input
				type="text" class="joinPhone" name="userPh3">
		</div>
		<div class="Form">
			<div class="joinName">EMAIL</div>
			<input type="hidden" name="userEmail" id="emailHidden"> <input
				type="text" class="joinEmail" name="userEmail1">@
			...
			<div><input type="button" value="인증받기" id="confirmEmail"></div>
		</div>
		...
		<div class="Form">
			...
			<input type="text" placeholder="우편번호" class="joinAddress"
				id="sample6_postcode"> <input type="button" value="우편번호 찾기"
				id="submitAddress" onclick="sample6_execDaumPostcode()">
		</div>
		<div class="Form">
			<div class="joinName"></div>
			<input type="text" name="userAddr" placeholder="주소" class="joinInput"
				id="sample6_address">
		</div>
		<div class="Form">
			<div class="joinName"></div>
			<input type="text" placeholder="상세주소 입력" class="joinInput"
